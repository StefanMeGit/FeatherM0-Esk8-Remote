...
void drawAnnouncement(){
  ...
  if ((millis() - announcementTimer < announcementDuration) || !announcementFade) {
    ...
    if(triggerTriggered && throttlePosition == MIDDLE){ // reset message when fade is off by trigger and throttle in middle pos
...
void drawCalibrationDisplay() {
  ...
  do {
    ...
    switch (calibrationStatus) {
      ...
      case 10:
        strText = "Move throttle";
        drawString(strText, strText.length(), 1, 30, u8g2_font_5x8_tf  );
        strText = "multiple times";
        drawString(strText, strText.length(), 1, 40, u8g2_font_5x8_tf  );
        strText = "forwards and backwards";
        ...
        strText = "to START";
        drawString(strText, strText.length(), 1, 105, u8g2_font_5x8_tf );
        strText = "calibration";
        drawString(strText, strText.length(), 1, 120, u8g2_font_5x8_tf );
      ...
      case 20:
        ...
        drawString(hallMinString, hallMinString.length(), 5, 85, u8g2_font_profont11_tr   );
        hallMaxString = String(txSettings.maxHallValue) + " - ";
        drawString(hallMaxString, hallMaxString.length(), 5, 45, u8g2_font_profont11_tr   );
        hallCenterString = String(hallValue);
        drawString(hallCenterString, hallCenterString.length(), 5, 65, u8g2_font_profont11_tr   );
        ...
        drawString(hallString, hallString.length(), 8, 120, u8g2_font_profont11_tr   );
      ...
      case 40:
        ...
        strText = "Throttle is";
        drawString(strText, strText.length(), 1, 40, u8g2_font_profont11_tr   );
        strText = "calibrated!";
        drawString(strText, strText.length(), 1, 50, u8g2_font_profont11_tr   );
